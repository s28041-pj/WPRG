        ...
        <ul>
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <?php if ($_SESSION['role'] === 'administrator'): ?>
                    <li><a href="/Projekt/admin/admin_dashboard.php">Admin Dashboard</a></li>
                <?php endif; ?>
                <?php if ($_SESSION['role'] === 'administrator'): ?>
                    <li><a href="/Projekt/admin/users.php">Manage Users</a></li>
                <?php endif; ?>
                <?php if ($_SESSION['role'] === 'administrator'): ?>
                    <li><a href="/Projekt/admin/admin_logs.php">Logs</a></li>
                <?php endif; ?>
                <?php if ($_SESSION['role'] == 'user' || $_SESSION['role'] == 'author'): ?>
                    <li><a href="/Projekt/admin/reset_password.php">Reset Password</a></li>
                <?php endif; ?>
